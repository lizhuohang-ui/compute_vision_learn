...
# 3X3 Conv2d + BN -> 3x3 Conv2d
def main():
    torch.random.manual_seed(42)

    Conv_Bn = nn.Sequential(OrderedDict(conv=nn.Conv2d(in_channels=2, out_channels=2, kernel_size=3,
    ...
    conv_weight_fuse = conv_weight * (gamma / std).reshape(-1, 1, 1, 1)
